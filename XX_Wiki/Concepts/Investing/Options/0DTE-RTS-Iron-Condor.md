...
tags:
  - MOC/Options
sources:
  - "Google Drive / 10_RAW / Archive Imports / JvL_Invest / Investing/Options/0DTE RTS Iron Condor.md"
source_file_id: "1n-XS9ZZiJmQCffN_MELw5dWGY9NC4FJg"
---

# 0DTE RTS Iron Condor
...
Nick’s approach, which he calls **Risk Tolerance Sequence (RTS)**, builds on the fundamentals of the breakeven iron condor trading style, such as my own [0DTE Breakeven Iron Condor](https://www.thetaprofits.com/my-most-profitable-options-trading-strategy-0dte-breakeven-iron-condor/)´strategy or the more disciplined [Multiple Entries Iron Condors (MEIC)](https://www.youtube.com/watch?v=cOoOaKvHRqk&t=16s) advocated by [Tammy Chambless](https://www.thetaprofits.com/backtesting-options-strategies-with-tammy-chambless/). This trading style tries to get the same premium on both sides of the [iron condor](https://www.thetaprofits.com/iron-condor/) – and sets the stop loss on each side separately equal to or a bit less than the total premium.
## Target:
...
![[40_ATTACHMENTS/JvL_Invest/Clippings/Pasted image 20251229170400.png]]

<!-- Ambiguous image basenames retained for review:
Pasted image 20251229170400.png: Clippings/Pasted image 20251229170400.png, 06_Clippings/Pasted image 20251229170400.png
-->
